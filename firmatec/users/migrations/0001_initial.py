# Generated by Django 3.2.3 on 2021-09-13 14:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banco', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='users.banco')),
                ('ciudad', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='utils.ciudad')),
                ('cliente', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='utils.cliente')),
                ...
                ('estado_civil', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='users.civil')),
                ...
                ('nacionalidad', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='users.nacionalidad')),
                ('planta', models.ManyToManyField(help_text='Seleccione solo una planta si el perfil que esta seleccionado es Trabajador.', to='utils.Planta')),
                ('provincia', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='utils.provincia')),
                ('region', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='utils.region')),
                ('sexo', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='users.sexo')),
                ('sistema_prevision', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='users.sistemaprevision')),
                ('sistema_salud', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='users.sistemasalud')),
                ('tipo_cuenta', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='users.tipocta')),
